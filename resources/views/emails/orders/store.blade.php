...
<body>
    ...
    <main style="padding: 10px 0;">
        ...
        <div class="center padding">Ваше замовлення збирається, як тільки буде зібрано ви отримаєте повідомлення на електронну пошту, та зможете забрати своє замовлення.</div>
        @else
        ...
        <div class="center padding">Ваше замовлення збирається, як тільки буде зібрано та віправлено ви отримаєте повідомлення на електронну пошту із номер віправлення.</div>
        @endif
