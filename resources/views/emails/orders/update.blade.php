...
<body>
    <header style="background: #222b33; padding-bottom: 15px; padding-top: 15px; margin-bottom: 15px">
        ...
        @if ($order->delivery_status == 'collected')
            ...
            <div class="center padding white">Замовлення можете забрати за адресою: Вул. Гагаріна 18, с. Соколово, Новомосковський район, Дніпропетровська область</div>
        @endif
        @if ($order->delivery_status == 'delivered')
            <h2 class="center white">Ваше замовлення відправлено!</h2>
            <div class="center padding white">Номер ТТН: <b>{{ $order->delivery_track }}</b>, слідкуйте у додатку Нова Пошта.</div>
        @endif
